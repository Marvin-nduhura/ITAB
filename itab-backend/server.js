...
function formatUnit(u) {
  ...
  return {
    ...
    floorNumber:   u.floor_number != null ? parseInt(u.floor_number) : null,
    bedrooms:      parseInt(u.bedrooms)      || 0,
    bathrooms:     parseInt(u.bathrooms)     || 0,
    squareFootage: u.square_footage != null ? parseInt(u.square_footage) : null,
    rentPrice:     parseInt(u.rent_price)    || 0,
    deposit:       u.deposit != null ? parseInt(u.deposit) : null,
    photos:        u.photos  || [],
    ...
    sortOrder:     parseInt(u.sort_order)    || 0,
    createdAt:     u.created_at,
    updatedAt:     u.updated_at,
  };
}
