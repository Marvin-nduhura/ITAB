    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          {/* ── Units section (apartments / commercial) ─────────────── */}
          {(property.type === 'apartment' || property.type === 'commercial') && (
            <UnitsSection property={property} isOwner={!!isOwner} />
          )}

          {/* Virtual Tour (YouTube embed) — shown if property has a tour URL) */}
          {property.tourUrl && (            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-card border border-slate-100 dark:border-slate-700 p-5">
